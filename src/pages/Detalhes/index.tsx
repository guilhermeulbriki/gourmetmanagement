  ...
  return (
    ...
    <S.Detalhes>
      ...
      <div>
        ...
        <p>Hamburguer do chefe, premiado mais de 10 vezes como o melhor hamburguer da região.</p>
        <span>R$ 40,00</span>
      </div>
    </S.Detalhes>
    <S.Line></S.Line>
    ...
    <S.Ingredientes>
      <h1>Ingredientes:</h1>
      <p>Pão de hamburguer, bacon, hamburguer de costela, cheedar, alface, tomate, cebola e molho da casa.</p>
